...
for ch=1:N_channels
    ...
    H_frequency_selective_LTI=Generate_Channel_frequency_selective_LTI(f,TX_pos,RX_pos_1,Yt,Zt,Yr,Zr,Limitsdeg_t,Limitsdeg_r,chi_r_deg,psi_r_deg,h_r_t,Ts,Tc,Ncl_min,Ncl_max,Nray);
    ...
    H_frequency_selective_LTI_2=Generate_Channel_frequency_selective_LTI(f,TX_pos,RX_pos_2,Yt,Zt,Yr,Zr,Limitsdeg_t,Limitsdeg_r,chi_r_deg,psi_r_deg,h_r_t,Ts,Tc,Ncl_min,Ncl_max,Nray);
    P=size(H_frequency_selective_LTI,3);
    while isequal(H_frequency_selective_LTI,zeros(Nr,Nt,P))
        H_frequency_selective_LTI=Generate_Channel_frequency_selective_LTI(f,TX_pos,RX_pos_2,Yt,Zt,Yr,Zr,Limitsdeg_t,Limitsdeg_r,chi_r_deg,psi_r_deg,h_r_t,Ts,Tc,Ncl_min,Ncl_max,Nray);
        P=size(H_frequency_selective_LTI,3);
    end
