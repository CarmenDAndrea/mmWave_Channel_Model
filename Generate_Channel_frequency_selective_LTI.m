function H=Generate_Channel_frequency_selective_LTI(f,TX_pos,RX_pos,Yt,Zt,Yr,Zr,Limitsdeg_t,Limitsdeg_r,chi_r_deg,psi_r_deg,a,Ts,Tc,Ncl_min,Ncl_max,Nray)
...
for ii=1:Ncl 
    ...
    for ll=1:Nray
        ...
        phir(ii,ll)=atan(r*sin(phit(ii,ll))/(distance1-r*cos(phit(ii,ll))))-chi_r;
